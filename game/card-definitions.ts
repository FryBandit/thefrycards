...
export const cardDefinitions: CardDefinition[] = [
  ...
  },
  {
    ...
    durability: 3,
    moraleValue: 5,
    text: "Arrival: Prophecy 1.",
    abilities: { "prophecy": 1 },
    rarity: "Uncommon",
  ...
  },
  {
    ...
    card_set: "Space Horror",
    author: "Fry",
    imageUrl: "https://cdn.midjourney.com/7e782637-bcbf-4cdf-8c9a-2afaab3ad2c3/0_0.png"
  },
  {
    id: 12,
    name: "The Hunger",
  ...
  },
  {
    ...
    type: CardType.UNIT,
    dice_cost: [{ type: DiceCostType.EXACT_VALUE, count: 2, value: 5 }, { type: DiceCostType.MIN_VALUE, count: 1, value: 3 }],
    strength: 4,
    durability: 5,
    moraleValue: 8,
  ...
  },
  {
    ...
    durability: 5,
    moraleValue: 9,
    text: "Stealth. Strike 2.",
    abilities: { "stealth": true, "strike": 2 },
    rarity: "Super-Rare",
  ...
  },
  {
    ...
    strength: undefined,
    durability: undefined,
    text: "Blessing: Target opponent discards 1 card. Haunt 1.",
    abilities: { "blessing": { "effect": { "type": "DISCARD", "value": 1 } }, "haunt": 1 },
    rarity: "Rare",
  ...
  },
  {
    ...
    durability: 7,
    moraleValue: 9,
    text: "Vanish 2. Malice 3.",
    abilities: { "vanish": { "turns": 2 }, "malice": 3 },
    rarity: "Super-Rare",
  ...
  },
  {
    ...
    strength: undefined,
    durability: undefined,
    text: "Instability. Blessing: Draw 1 card.",
    abilities: { "instability": true, "blessing": { "effect": { "type": "DRAW_CARD", "value": 1 } } },
    rarity: "Super-Rare",
  ...
  },
  {
    ...
    type: CardType.LOCATION,
    dice_cost: [{ type: DiceCostType.SUM_OF_X_DICE, "value": 15, "count": 3 }],
    strength: undefined,
    durability: undefined,
    text: "Landmark. Blessing: Disrupt 1.",
    abilities: { "landmark": true, "blessing": { "effect": { "type": "DISRUPT", "value": 1 } } },
    rarity: "Mythic",
  ...
  },
  {
    ...
    durability: 10,
    moraleValue: 10,
    text: "Obliterate. Siphon 3.",
    abilities: { "obliterate": true, "siphon": 3 },
    rarity: "Mythic",
  ...
  },
  {
    ...
    strength: undefined,
    durability: undefined,
    text: "Banish all units. Purge 3. Target opponent discards 3 cards.",
    abilities: { "obliterate": true, "purge": 3, "discard": 3 },
    rarity: "Mythic",
  ...
  },
  {
    ...
    type: CardType.EVENT,
    dice_cost: [{ type: DiceCostType.STRAIGHT, "count": 4 }, { type: DiceCostType.MIN_VALUE, count: 1, value: 5 }],
    strength: undefined,
    durability: undefined,
    text: "Warp.",
    abilities: { "warp": true },
  ...
  },
  {
    ...
    strength: undefined,
    durability: undefined,
    text: "Exhaust. Disrupt 1.",
    abilities: { "exhaust": true, "disrupt": 1 },
    rarity: "Uncommon",
  ...
  },
  {
    ...
    abilities: { "passive_buff": { "type": "STRENGTH", "value": 1, "card_set": "Rainbow Riot Squad" } },
    rarity: "Rare",
  ...
  },
  {
    ...
    durability: undefined,
    text: "Reclaim.",
    abilities: { "reclaim": { "cost": [{ type: DiceCostType.ANY_PAIR }] } },
    rarity: "Common",
  ...
  },
  {
    ...
    type: CardType.UNIT,
    dice_cost: [{ type: DiceCostType.SUM_OF_X_DICE, "value": 22, "count": 4 }],
    strength: 8,
    durability: 8,
    moraleValue: 10,
  ...
  },
  {
    ...
    strength: undefined,
    durability: undefined,
    text: "Blessing: At the start of your turn, return a random Unit from your graveyard to your hand.",
    abilities: { "blessing": { "effect": { "type": "RECYCLE_UNIT", "value": 1 } } },
    rarity: "Uncommon",
  ...
  },
  {
    ...
    type: CardType.UNIT,
    dice_cost: [{ type: DiceCostType.SUM_OF_X_DICE, "value": 17, "count": 3 }],
    strength: 5,
    durability: 10,
    moraleValue: 10,
  ...
  },
{
  ...
  },
  {
    ...
    strength: undefined,
    durability: undefined,
    text: "Blessing: At the start of your turn, Prophecy 1.",
    abilities: { "blessing": { "effect": { "type": "PROPHECY", "value": 1 } } },
    rarity: "Common",
  ...
  },
  {
    ...
    durability: 2,
    moraleValue: 7,
    text: "Fragile. Strike 2. Charge.",
    abilities: { "fragile": true, "strike": 2, "charge": true },
    rarity: "Rare",
  ...
  },
  {
    ...
    type: CardType.UNIT,
    dice_cost: [{ type: DiceCostType.TWO_PAIR }, { type: DiceCostType.EXACT_VALUE, count: 1, value: 6 }],
    strength: 10,
    durability: 10,
    moraleValue: 10,
    text: "Obliterate. Warp.",
    abilities: { "obliterate": true, "warp": true },
    rarity: "Mythic",
