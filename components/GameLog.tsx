...
const GameLog: React.FC<GameLogProps> = ({ log }) => {
  ...
  return (
    <div className="absolute top-4 left-4 w-80 h-full bg-cyber-surface/70 backdrop-blur-sm rounded-lg p-2 text-white text-xs font-mono flex flex-col z-20 border-2 border-cyber-border">
